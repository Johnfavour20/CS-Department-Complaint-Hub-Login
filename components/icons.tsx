...
export const AcademicCapIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path d="M9.813 15.904 9 16.5v-4.5l.813-.596a.375.375 0 0 1 .574 0l.813.596v4.5l-.813-.596a.375.375 0 0 1-.574 0ZM12 16.5v-4.5l.813-.596a.375.375 0 0 1 .574 0l.813.596v4.5l-.813-.596a.375.375 0 0 1-.574 0ZM14.187 15.904 15 16.5v-4.5l-.813-.596a.375.375 0 0 1-.574 0l-.813.596v4.5l.813-.596a.375.375 0 0 1 .574 0Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a8.25 8.25 0 0 1-8.25-8.25V9a.75.75 0 0 1 .75-.75h15a.75.75 0 0 1 .75.75v3.75a8.25 8.25 0 0 1-8.25 8.25Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a8.25 8.25 0 0 1-8.25-8.25V9a.75.75 0 0 1 .75-.75h15a.75.75 0 0 1 .75.75v3.75a8.25 8.25 0 0 1-8.25 8.25Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 16.5v.75a.75.75 0 0 0 .75.75h4.5a.75.75 0 0 0 .75-.75v-.75" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 2.25a.75.75 0 0 1 .75.75v1.875a.75.75 0 0 1-1.5 0V3a.75.75 0 0 1 .75-.75Z" />
    </svg>
);
...
export const WrenchScrewdriverIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="m11.25 6-1.125 1.125-6.064 6.064a.75.75 0 0 0 0 1.06l1.06 1.06a.75.75 0 0 0 1.06 0l6.064-6.064L13.5 9.75m0 0 2.25 2.25M11.25 6h1.5a2.25 2.25 0 0 1 2.25 2.25v1.5a2.25 2.25 0 0 1-2.25 2.25h-1.5a2.25 2.25 0 0 1-2.25-2.25v-1.5A2.25 2.25 0 0 1 9 6h2.25Z" />
    </svg>
);
export const ShieldExclamationIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m0-10.036V4.875M12 15h.008v.008H12V15Zm-3-1.612a5.25 5.25 0 0 1 6 0m-6 0a5.25 5.25 0 0 0-1.88 3.868L6.75 16.5A.75.75 0 0 0 7.5 17.25h9a.75.75 0 0 0 .75-.75l-1.12-3.244a5.25 5.25 0 0 0-1.88-3.868" />
    </svg>
);
...
export const Cog6ToothIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.003 1.11-1.226a2.25 2.25 0 0 1 2.593 1.226c.09.542.56 1.003 1.11 1.226a2.25 2.25 0 0 1 1.226 2.593c-.223.55-.684 1.02-1.226 1.11a2.25 2.25 0 0 1-2.593-1.226c-.09-.542-.56-1.003-1.11-1.226a2.25 2.25 0 0 1-1.226-2.593c.223-.55.684-1.02 1.226-1.11ZM12.75 15a3.75 3.75 0 1 0 0-7.5 3.75 3.75 0 0 0 0 7.5Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12a8.25 8.25 0 0 1 15 0c0 1.625-.462 3.14-1.252 4.437l.03.029a.75.75 0 0 1-.228 1.132l-6.435 3.28a.75.75 0 0 1-.82-.12l-3.28-6.435a.75.75 0 0 1 1.132-.228l.029.03A8.25 8.25 0 0 1 3.75 12Z" />
    </svg>
);
